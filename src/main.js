...
(function() {
    ...
    function onReady() {
        ...
        // ===== ПЛАВАЮЩАЯ FAB-КНОПКА (Speed Dial, фиксированная) =====
        (function() {
            ...
            // Принудительно удаляем width/height у иконок внутри FAB
            setTimeout(function() {
            ...
            function setFabIcon(name) {
                ...
                // Удаляем width/height у всех svg внутри FAB и задаём нужный размер
                document.querySelectorAll('#fab-menu svg').forEach(function(svg) {
                    svg.removeAttribute('width');
                    svg.removeAttribute('height');
